...
proc genmod data = alzheimer_long_centered descending;
    ...
    TIME * TIME * SEX TIME * TIME * AGE_STD TIME * TIME * BMI_STD TIME * TIME * ADL TIME * TIME * TAUPET_STD TIME * TIME * ABPET_STD /
...
proc genmod data = alzheimer_long_centered descending;
	...
	model CDRSB_CAT = TIME TIME * TIME TIME * TIME * TIME SEX AGE_STD BMI_STD ADL TAUPET_STD ABPET_STD 
    TIME * SEX TIME * AGE_STD TIME * BMI_STD TIME * ADL TIME * TAUPET_STD TIME * ABPET_STD 
    TIME * TIME * SEX TIME * TIME * AGE_STD TIME * TIME * BMI_STD TIME * TIME * ADL TIME * TIME * TAUPET_STD TIME * TIME * ABPET_STD 
    TIME * TIME * TIME * SEX TIME * TIME * TIME * AGE_STD TIME * TIME * TIME * BMI_STD 
    TIME * TIME * TIME * ADL TIME * TIME * TIME * TAUPET_STD TIME * TIME * TIME * ABPET_STD/
