...
proc genmod data = alzheimer_long_centered descending;
    ...
    model CDRSB_CAT = TIME SEX AGE_STD BMI_STD TAUPET_STD ABPET_STD ADL 
    TIME * SEX TIME * AGE_STD TIME * BMI_STD TIME * TAUPET_STD TIME * ABPET_STD TIME * ADL /
...
proc genmod data = alzheimer_long_centered descending;
    ...
    model CDRSB_CAT = TIME SEX AGE_STD BMI_STD TAUPET_STD 
